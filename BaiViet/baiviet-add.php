...
_MESSAGE;
    ...
    <form name="f_add" action="baiviet-add.php" method="post">
        <pre>
    Mã bài viết <input type="text" size="5" name="ma_bviet" value="<?php echo get_ma_bviet();?>">
    Tiêu đề <input type="text" size="70" name="tieude">
    Tác giả <select name="ma_tgia"><?php dropdown_options('tacgia','ma_tgia','ten_tgia'); ?></select>
    Ngày viết <input type="text" size="11" name="ngayviet" id="ngayviet">
    Bài hát <input type="text" size="40" name="ten_bhat">
    Thể loại <select name="ma_tloai"><?php dropdown_options('theloai', 'ma_tloai', 'ten_tloai'); ?>
</select>   
